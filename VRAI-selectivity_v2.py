...
def main(filename1, filename2, filename3, filename4, filename5, filename6, filename7, filename8, intermediate_option, weight_option):

    code_name = 'VRAI-selectivity_'
    ...
    if TST_valid == True:
        ...
        if TS2A_G < TS2B_G:
            ...
            logging.info('')
            logging.info('The difference in free energy between TS1 and TS2 is found to be less than 7 kJ/mol. The algorithm will use TST to predict the product ratios')
            logging.info('')
            logging.info('Delta_G(INT-TS1) = '+str(round(TS1INT_DeltaG,1))+' kJ/mol')
            logging.info('Delta_G(INT-TS2A) = '+str(round(TS2AINT_DeltaG,1))+' kJ/mol')
            logging.info('Delta_G(INT-TS2B) = '+str(round(TS2BINT_DeltaG,1))+' kJ/mol')
            ...
            print ''
            print 'The difference in free energy between TS1 and TS2 is found to be less than 7 kJ/mol. The algorithm will use TST to predict the product ratios'
            print ''
...
if __name__ == '__main__':
    ...
    parser.add_argument('GausFile6', help="Gaussian frequency output file for INT")
    ...
    main(args.GausFile1, args.GausFile2, args.GausFile3, args.GausFile4, args.GausFile5, args.GausFile6, args.GausFile7_option, args.GausFile8_option, args.intermediate_option, args.weight_option)
